...
const MyProfile = () => {
    const [userData, setUserData] = useState({
        ...
        phone: "+91 1234567899",
        address: {
          line1: "Sivanpada Street, Tiruvannamalai",
          line2: "Tamil Nadu"
        },
        gender: "Female",
        dob: "2004-08-24"
    ...
    return (
        <div>
            ...
            <div className='mt-10'>
                <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={() => setIsEdit(!isEdit)}>
